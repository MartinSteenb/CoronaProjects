...
function scene:create( event )
  ...
  -- Set up display groups
    backgroundGroup = display.newGroup()  -- Display group for the background image
    sceneGroup:insert(backgroundGroup)  -- Insert into the scene's view group
 
    mainObjectsGroup = display.newGroup()  -- Display group for the ship, asteroids, lasers, etc.
    sceneGroup:insert(mainObjectsGroup)  -- Insert into the scene's view group
    ...
    scoreText = display.newText(uiGroup, "Score: ".. score, 550, 50, native.systemFont, 36)
